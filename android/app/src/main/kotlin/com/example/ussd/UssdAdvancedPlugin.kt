...
class UssdAdvancedPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, BasicMessageChannel.MessageHandler<String?>  {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "method.com.example.ussd/ussd_advance")
        channel.setMethodCallHandler(this)
        this.context = flutterPluginBinding.applicationContext
        basicMessageChannel  = BasicMessageChannel(
            flutterPluginBinding.binaryMessenger,
            "message.com.example.ussd/ussd_advance", StringCodec.INSTANCE
        )
    }
...
//            result.success(ev.text.first().toString())
    ...
    private fun isAccessibilityServiceEnabled(context: Context): Boolean{
        ...
        val service = "com.example.ussd.ussd_advance.USSDServiceKT1"
