...
class UssdAdvanced {
  ...
  MethodChannel('method.com.example.ussd/ussd_advance');
  //Initialize BasicMessageChannel
  static const BasicMessageChannel<String> _basicMessageChannel =
  BasicMessageChannel("message.com.example.ussd/ussd_advance", StringCodec());
  ...
  static Future<String?> multisessionUssd(
    ...
    debugPrint("code = ${_codeItem.code}");
    if(_codeItem.messages!=null) debugPrint("messages = ${_codeItem.messages!.join(",")}");
